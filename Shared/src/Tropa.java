...
/**
 * Objecte que guarda tota l ainformació de les tropes de l'usuari, hereda de la classe Entity e implementa la classe Serializable
 */
public class Tropa extends Entity implements Serializable {
     ...
     * @param xPosition indica la posició x
     * @param yPosition indica la posició y
     * @param sprite indica la imatge assignada a un quadrat
     * */
